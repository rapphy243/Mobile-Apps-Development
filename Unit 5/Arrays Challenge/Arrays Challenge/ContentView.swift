...
struct ContentView: View {
     ...
     ************************************/
    @State private var myFavoriteMovies : [String]? = ["The Martian", "The Advengers", "Your Name", "Spider Man into the Spiderverse", "Interstellar"]
                ...
                if s1Check == 0 {
                    Button("Test Stretch 1") {
                        ...
                        if var myFavoriteMovies = myFavoriteMovies {
                             ...
                             ************************************/
                            myFavoriteMovies[1] = "The Lion King"
                            myFavoriteMovies.append("Forest Gump")
                            myFavoriteMovies.insert("The Persuit of Happyness", at: 2)
